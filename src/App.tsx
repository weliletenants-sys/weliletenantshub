...
const LandlordNotifications = lazy(() => import("./pages/manager/LandlordNotifications"));
...
const AgentCommissionHistory = lazy(() => import("./pages/agent/CommissionHistory"));
...
const ManagerSuspensionHistory = lazy(() => import("./pages/manager/SuspensionHistory"));
      ...
      <BrowserRouter>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/agent/commission-history" element={
              <ProtectedRoute requiredRole="agent">
            ...
            <Route path="/manager/landlords/notifications" element={
              <ProtectedRoute requiredRole="manager">
            ...
            <Route path="/manager/suspension-history" element={
              <ProtectedRoute requiredRole="manager">
                <ManagerSuspensionHistory />
              </ProtectedRoute>
            } />
            ...
            <Route path="/manager/version-history" element={
              <ProtectedRoute requiredRole="manager">
                <ManagerVersionHistory />
              </ProtectedRoute>
            } />
            <Route path="/manager/tid-history" element={
              <ProtectedRoute requiredRole="manager">
                <ManagerTIDHistory />
              </ProtectedRoute>
            } />
